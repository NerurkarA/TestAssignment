...
public class StockTransaction {
	...
	/**
	 * @param stockName				StockName of StockTransaction
	 * @param settlementDate		settlementDate of StockTransaction
	 * @param instructionDate		instructionDate of StockTransaction
	 * @param instructionType		instructionType of StockTransaction
	 * @param agreedFix				agreedFix of StockTransaction
	 * @param currencyType			currencyType of StockTransaction
	 * @param units					units of StockTransaction
	 * @param pricePerUnit			pricePerUnit of StockTransaction
	 * @param holdingValue			holdingValue of StockTransaction
	 * @param status				status of StockTransaction
	 */
