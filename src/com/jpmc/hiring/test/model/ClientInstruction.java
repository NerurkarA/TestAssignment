...
public class ClientInstruction {
	...
	/**
	 * @param stockName			StockName of ClientInstruction
	 * @param instructionType	instructionType of ClientInstruction
	 * @param agreedFix			agreedFix of ClientInstruction
	 * @param currencyType		currencyType of ClientInstruction
	 * @param instructionDate	instructionDate of ClientInstruction
	 * @param settlementDate	settlementDate of ClientInstruction
	 * @param units				units of ClientInstruction
	 * @param pricePerUnit		pricePerUnit of ClientInstruction
	 */
