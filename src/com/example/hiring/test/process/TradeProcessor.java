...
public class TradeProcessor {
	...
	public List<ClientInstruction> populateClientInstruction() {
		 ...
		 * "YEN", "20 Jun 2018", "02 Jul 2018", 14, 120.25);
		 * 
		 * ClientInstruction instruction26 = new ClientInstruction("SQ", "S", 0.65,
		 * "YEN", "20 Jun 2018", "02 Jul 2018", 6, 100.25);
		 * 
		 * ClientInstruction instruction27 = new ClientInstruction("SMJ", "S", 0.65,
		 * "YEN", "20 Jun 2018", "02 Jul 2018", 10, 120.25);
		 * 
		 * ClientInstruction instruction28 = new ClientInstruction("ABC", "B", 0.20,
		 * "SAR", "20 Jun 2018", "26 Jun 2018", 6, 1432.25); ClientInstruction
		 * instruction29 = new ClientInstruction("RTAZ", "S", 0.50, "AED",
		 * "27 Jun 2018", "03 Jul 2018", 23, 65.25); ClientInstruction instruction30 =
		 * new ClientInstruction("ASTS", "S", 0.22, "SGP", "27 Jun 2018", "03 Jul 2018",
		 * 7, 430.25); ClientInstruction instruction31 = new ClientInstruction("XSD",
		 * "B", 0.42, "PESO", "2 Jul 2018", "18 Jul 2018", 23, 20.25); ClientInstruction
		 * instruction32 = new ClientInstruction("AMTX", "S", 0.150, "DOLLAR",
		 * "20 Jun 2018", "04 Jul 2018", 43, 61.25); ClientInstruction instruction33 =
		 * new ClientInstruction("GADO", "B", 0.75, "AED", "26 Jun 2018", "29 Jun 2018",
		 * 43, 35.25); ClientInstruction instruction34 = new ClientInstruction("GLAF",
		 * "S", 0.65, "YEN", "12 Jul 2018", "19 Jul 2018", 15, 61.25); ClientInstruction
		 * instruction35 = new ClientInstruction("PZW", "B", 0.35, "AED", "28 Jun 2018",
		 * "18 Jul 2018", 30, 450.25); ClientInstruction instruction36 = new
		 * ClientInstruction("ZAEN", "S", 0.50, "SGP", "02 Jul 2018", "04 Jul 2018", 45,
		 * 124.65); ClientInstruction instruction37 = new ClientInstruction("SQSA", "S",
		 * 0.65, "YEN", "20 Jun 2018", "26 Jun 2018", 14, 10.25);
		 * 
		 * ClientInstruction instruction38 = new ClientInstruction("QSB", "S", 0.65,
		 * "YEN", "20 Jun 2018", "28 Jun 2018", 14, 90.25);
		 * 
		 * ClientInstruction instruction39 = new ClientInstruction("SQM", "S", 0.65,
		 * "YEN", "20 Jun 2018", "29 Jun 2018", 12, 80.25);
		 * 
		 * ClientInstruction instruction40 = new ClientInstruction("ZSMJ", "S", 0.65,
		 * "YEN", "20 Jun 2018", "02 Jul 2018", 14, 20.25);
		 * 
		 ...
		 * "SGP", "29 Jun 2018", "02 Jul 2018", 34, 300.25); ClientInstruction
		 * instruction43= new ClientInstruction("BAT", "S", 0.22, "AED", "02 Jul 2018",
		 * "04 Jul 2018", 40, 120.5); ClientInstruction instruction44= new
		 * ClientInstruction("TCA", "B", 0.42, "INR", "27 Jun 2018", "29 Jun 2018", 60,
		 * 1230.5); ClientInstruction instruction45= new ClientInstruction("BRT", "S",
		 * 0.24, "INR", "27 Jun 2018", "30 Jun 2018", 30, 35.5); ClientInstruction
		 * instruction46 = new ClientInstruction("BKY", "B", 0.44, "AED", "24 Jun 2018",
		 * "29 Jul 2018", 30, 43.5); ClientInstruction instruction47 = new
		 * ClientInstruction("INTY", "B", 0.25, "AED", "03 Jul 2018", "18 Jul 2018", 32,
		 * 42.5);
		 * 
		 * ClientInstruction instruction48= new ClientInstruction("ACW", "B", 0.20,
		 * "SGP", "03 Jul 2018", "18 Jul 2018", 20, 94.25);
		 */
